    ...
    <section id="sobre-mi" className="relative px-6 py-28">
      <div className="mx-auto max-w-5xl">
        <SectionHeading
          ...
          description="Desde la interfaz hasta el servidor que la sirve."
        />

        <div className="mt-14 grid gap-12 md:grid-cols-2 md:items-center">
          <Reveal delay={0.1}>
            <p className="text-zinc-300">
              Soy desarrollador full stack y me muevo con comodidad en todo
              el ciclo de vida de una aplicación: diseño interfaces con{" "}
              <span className="text-zinc-100">Next.js</span>, construyo
              servicios con <span className="text-zinc-100">Node.js</span> y{" "}
              <span className="text-zinc-100">Spring Boot</span>, modelo
              datos en <span className="text-zinc-100">MySQL</span>,{" "}
              <span className="text-zinc-100">SQL Server</span> y{" "}
              <span className="text-zinc-100">PostgreSQL</span>, y participo
            ...
            <p className="mt-4 text-zinc-300">
              ...
              <span className="text-zinc-100">Jenkins</span> para que cada
              entrega sea predecible. Fuera del código, creo que el mejor
          ...
          <Reveal delay={0.2}>
            <div className="grid grid-cols-2 gap-4">
              {STATS.map((stat) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-white/10 bg-white/[0.03] p-6 text-center transition-colors hover:border-white/20"
                >
